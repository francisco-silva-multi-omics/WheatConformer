...
optional_hmp_kernels=()
if [[ -s genotype_panels/pedigree/K_A.npy && -s genotype_panels/pedigree/K_A_sample_order.tsv ]]; then
  optional_hmp_kernels+=(--k-a genotype_panels/pedigree/K_A.npy --k-a-order genotype_panels/pedigree/K_A_sample_order.tsv)
fi
if [[ -s model_kernels/K_z.npy && -s model_kernels/K_z_sample_order.tsv ]]; then
  optional_hmp_kernels+=(--k-z model_kernels/K_z.npy --k-z-order model_kernels/K_z_sample_order.tsv)
fi
