...
|---|---|---|---|---|---|
| raw_trials | `build_baseline.py::build_phenotypes_and_environment` | TRIALS_AND_NURSERIES_DATA/** | phenotypes/model_input_phenotypes.tsv | trial/cycle/occ/GID/trait | mean duplicate numeric summaries |
...
| K_G | `build_baseline.py::compute_hmp_qc; vanraden_kernel` | HMP HapMap marker file | genotype_panels/hmp/K_HMP.QCfiltered.meanDiag1.npy | sample_id order | marker-mean imputation; VanRaden; mean-diagonal scale |
