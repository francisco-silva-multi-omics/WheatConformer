...
def static_lineage(
    ...
    rows = [
        ("raw_trials", f"{trial_label}/**", "build_baseline.py", "build_phenotypes_and_environment", "phenotypes/model_input_phenotypes.tsv", "trial/cycle/occ/GID/trait", "source-specific parsing; numeric means", "mean duplicate numeric summaries"),
        ...
        ("K_G", "HMP HapMap marker file", "build_baseline.py", "compute_hmp_qc; vanraden_kernel", "genotype_panels/hmp/K_HMP.QCfiltered.meanDiag1.npy", "sample_id order", "MAF/missing/heterozygosity QC", "marker-mean imputation; VanRaden; mean-diagonal scale"),
