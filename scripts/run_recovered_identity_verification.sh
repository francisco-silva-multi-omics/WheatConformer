...
OUT_DIR="${RECOVERED_IDENTITY_VERIFICATION_OUT_DIR:-genotype_panels/recovered_identity_verification_v2}"
...
"$PYTHON" -P -m server_genotype_recovery.verify_recovered_identity_evidence \
  --root . \
  --policy "$CODE_ROOT/server_genotype_recovery/recovered_identity_verification_policy_v2.json" \
