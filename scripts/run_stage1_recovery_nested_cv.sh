...
EVALUATION_DIR="${STAGE1_RECOVERY_EVALUATION_DIR:-model_kernels/stage1_recovery_nested_v3}"
FREEZE_DIR="${STAGE1_RECOVERY_FREEZE_DIR:-audit/stage1_recovery_nested_v3}"
OUTER_DIR="${STAGE1_RECOVERY_OUTER_DIR:-model_kernels/stage1_recovery_reaction_norm_outer_v3}"
MODELS_DIR="${STAGE1_RECOVERY_MODELS_DIR:-trained_models/stage1_recovery_reaction_norm_outer_v3_runs}"
SUMMARY_DIR="${STAGE1_RECOVERY_SUMMARY_DIR:-trained_models/stage1_recovery_reaction_norm_outer_v3_summary}"
AUDIT_DIR="${STAGE1_RECOVERY_NESTED_AUDIT_DIR:-audit/stage1_recovery_reaction_norm_outer_v3}"
