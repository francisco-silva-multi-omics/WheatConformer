...
def attrition_rows() -> list[dict[str, object]]:
    return [
        {"priority": "P0", "point": "raw_source_discovery_scope", "observed_effect": "repository-wide recursive scan can include explicit raw roots and duplicate top-level trial folders", "evidence": "build_baseline.py:689; duplicate local directories", "phase2_action": "replace discovery with hash-bound explicit raw-root manifest"},
