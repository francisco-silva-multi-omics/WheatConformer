...
if [[ ! -f "$CODE/server_training_pipeline/stage1_v2_phase6_factor_analytic_optimization_amendment_protocol_v1.json" ]]; then
...
echo "FREEZE bounded FA optimization amendment"
...
echo "Started Stage-1 v2 FA optimization amendment"
echo "pid=$PID"
echo "log=$LOG"
echo "reference_reuses=5 new_model_fits=10 same_seed_replay_fits=2"
