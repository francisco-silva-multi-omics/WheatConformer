...
STATE="$DATA/audit/v2/stage1_v2_phase6_factor_analytic_optimization_amendment_server_cpu_v1"
PID_FILE="$STATE/screen.pid"
LATEST="$STATE/latest_log.txt"
RUNS="$DATA/trained_models/stage1_v2_phase6_factor_analytic_optimization_amendment_v1_runs"
REPLAY_RUNS="$DATA/trained_models/stage1_v2_phase6_factor_analytic_optimization_amendment_v1_same_seed_replay_runs"
STATUS="$DATA/model_kernels/stage1_v2_phase6_factor_analytic_optimization_amendment_v1/phase_1/fa_optimization_amendment_status.json"
