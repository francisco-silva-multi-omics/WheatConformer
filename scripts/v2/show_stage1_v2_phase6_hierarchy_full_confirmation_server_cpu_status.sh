...
RUNS="$DATA/trained_models/stage1_v2_phase6_hierarchy_full_confirmation_v1_runs"
STATUS="$DATA/model_kernels/stage1_v2_phase6_hierarchy_full_confirmation_v1/full_confirmation_status.json"
...
for path in pathlib.Path(sys.argv[1]).rglob("run_metadata.json"):
    ...
    if (
        ...
        == "stage1_v2_phase6_hierarchy_full_confirmation_tf_v1"
...
echo "certified_matched_runs=$COMPLETE/50"
echo "routed_states=125 active_hierarchy_states=25 exact_reference_reuse_states=100"
