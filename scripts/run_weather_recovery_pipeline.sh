...
if [[ "${WEATHER_RECOVERY_RUN_TRAINING:-0}" == "1" ]]; then
  ...
  env \
    ...
    MULTITRAIT_REQUIRE_ACTIVE_KERNELS="${MULTITRAIT_REQUIRE_ACTIVE_KERNELS:-}" \
    MULTITRAIT_EXCLUDE_KERNELS="${MULTITRAIT_EXCLUDE_KERNELS:-}" \
    MULTITRAIT_FORBID_ACTIVE_KERNELS="${MULTITRAIT_FORBID_ACTIVE_KERNELS:-}" \
