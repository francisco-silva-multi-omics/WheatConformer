...
SINGLE_STEP_DIR="${SINGLE_STEP_OUT_DIR:-model_kernels/single_step_H_v2}"
SCREEN_DIR="${SINGLE_STEP_SCREEN_DIR:-model_kernels/single_step_H_inner_screen_v2}"
MODELS_DIR="${SINGLE_STEP_MODELS_DIR:-trained_models/single_step_H_inner_screen_v2_runs}"
